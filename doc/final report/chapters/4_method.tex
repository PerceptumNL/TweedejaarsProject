...
\begin{figure}[h]
\subfigure[Weighted tags]{	\includegraphics[width =0.24\textwidth]{images/threshold_weighted_tag}	}
\subfigure[text]{				\includegraphics[width =0.24\textwidth]{images/threshold_text} 			}
\subfigure[tag smoothing]{	\includegraphics[width =0.24\textwidth]{images/threshold_smoothing} 		}
\subfigure[glossaries]{		\includegraphics[width =0.24\textwidth]{images/threshold_glossary} 		}
...
\begin{figure}[h]
\subfigure[Weighted tags]{	\includegraphics[width =0.24\textwidth]{images/threshold_weighted_tag_difference}		}
\subfigure[text]{				\includegraphics[width =0.24\textwidth]{images/threshold_text_difference} 			}
\subfigure[tag smoothing]{	\includegraphics[width =0.24\textwidth]{images/threshold_smoothing_difference} 		}
\subfigure[glossaries]{		\includegraphics[width =0.24\textwidth]{images/threshold_glossary_difference} 		}
