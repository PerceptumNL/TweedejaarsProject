...
Starfish text content is serialized as HTML, a format which is not suitable for calculating semantical similarity. Before processing, we sanitize the data by removing HTML tags and entities, convert unicode characters to their closest ASCII representation.
...
\begin{figure}[h]
\subfigure[Weighted tags]{	\includegraphics[width =0.45\textwidth]{images/threshold_weighted_tag}	}
\subfigure[text]{				\includegraphics[width =0.45\textwidth]{images/threshold_text} 			}
\subfigure[tag smoothing]{	\includegraphics[width =0.45\textwidth]{images/threshold_smoothing} 		}
\subfigure[glossaries]{		\includegraphics[width =0.45\textwidth]{images/threshold_glossary} 		}
